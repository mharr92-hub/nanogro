...
const caseText: Record<string, Record<Locale, LocalizedCaseText>> = {
  ...
  "real-012": pair("Guava recovery under nematode pressure", "Guava protocol documenting root and foliage recovery after Nano-Gro under dry conditions and nematode pressure.", "Nano-Gro application followed by another application with eco-mineral fertilization.", "Photos documented new shoots, root emission and recovery versus untreated control.", "Recuperacion de guayaba bajo presión de nematodos", "Protocolo de guayaba que documenta recuperacion de raiz y follaje después de Nano-Gro bajo sequia y presión de nematodos.", "Aplicación de Nano-Gro seguida por otra aplicación con fertilizacion eco-mineral.", "Las fotos documentaron nuevos brotes, emision de raices y recuperacion frente al testigo sin tratamiento."),
  "real-013": pair("Cabbage seed protocol in El Salvador", "Cabbage seed application protocol for Marien variety.", "Nano-Gro seed-stage protocol.", "Protocol and photos are preserved for agronomic review.", "Protocolo de semilla de repollo en El Salvador", "Protocolo de aplicación en semilla de repollo variedad Marien.", "Protocolo Nano-Gro en etapa de semilla.", "El protocolo y las fotos quedan preservados para revisión agronomica."),
  ...
  "real-019": pair("Ixil Guatemala Nano-Gro presentation", "Region Ixil Guatemala presentation imported as real field evidence.", undefined, "Presentation PDF is available for review and conversión.", "Presentacion Nano-Gro Region Ixil Guatemala", "Presentacion de Region Ixil Guatemala importada como evidencia real de campo.", undefined, "El PDF de la presentacion esta disponible para revisión y conversión."),
  "real-020": pair("México final Nano-Gro report", "Official-format final Nano-Gro México report imported from the source folder.", undefined, "PDF requires conversión before extracting crop, protocol and result metrics.", "Informe final Nano-Gro México", "Informe final de Nano-Gro México en formato oficial importado desde la carpeta fuente.", undefined, "El PDF requiere conversión antes de extraer cultivo, protocolo y métricas de resultado."),
  "real-021": pair("Nigeria pepper results 2009", "Legacy Word pepper results from Nigeria, 2009.", undefined, "Legacy .doc requires conversión before quantified fields can be verified.", "Resultados de chile en Nigeria 2009", "Resultados de chile en Nigeria, 2009, en documento Word heredado.", undefined, "El archivo .doc requiere conversión antes de verificar campos cuantificados."),
  "real-022": pair("Poland tomato results", "Poland tomato results PDF imported as real evidence.", undefined, "PDF requires conversión before final metrics can be verified.", "Resultados de tomate en Polonia", "PDF de resultados de tomate en Polonia importado como evidencia real.", undefined, "El PDF requiere conversión antes de verificar métricas finales."),
  "real-023": pair("Jamaican treated plants", "Legacy Word report for treated plants in Jamaica.", undefined, "Legacy .doc requires conversión before structured metrics can be extracted.", "Plantas tratadas en Jamaica", "Informe Word heredado sobre plantas tratadas en Jamaica.", undefined, "El archivo .doc requiere conversión antes de extraer métricas estructuradas."),
  ...
  "real-025": pair("Vegetable protocol source", "Legacy horticulture source imported for later conversión.", undefined, "Legacy .doc requires conversión before crop-specific cases can be split.", "Fuente de protocolo para hortalizas", "Fuente heredada de horticultura importada para conversión posterior.", undefined, "El archivo .doc requiere conversión antes de dividir casos por cultivo."),
